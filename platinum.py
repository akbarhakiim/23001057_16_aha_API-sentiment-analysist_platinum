...
# parameter feature extraction lstm
max_features = 100000
...
# load model lstm
model_lstm = load_model('model_of_lstm/model_lstm_platinum.h5')
print(model_lstm.summary())

# load model neural network
count_vect = CountVectorizer()
count_vect = pickle.load(open('resources_of_nn/feature_platinum_nn.p', 'rb'))
loaded_model = pickle.load(open('model_of_nn/model_platinum_nn.p', 'rb'))
